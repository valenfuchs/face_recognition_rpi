...
# Route to handle the form submission and start face capturing
...
def start_capture():
    ...
    # Redirect to a capturing page or wherever needed
    return redirect(url_for('capturing'))

# Route to render the capturing.html template
@app.route('/capturing')
def capturing():
